...
def randomize_keys(char_locs,outfile,locked_chars):
    ...
    if iterations == 3600:
       ...
       "melchior" ,"claw" ,"desert" ,"arris" ,"geno" ,"sun" ,"reptite" ,"woe"]
       pointer1 = [0x393C82,0x35F888,0x3773F1,0x380C42,0x3891DE,0x3966B,0x38045D,0x3805DE,0x1B8AEC,
       0x6EF5E,0x392F4C,0x1B1844,0x1B8D95,0x18FC04,0x381010]
       pointer2 = [0x393C84,0x35F88A,0x3773F3,0x380C5B,0x3891E0,0x3966D,0x38045F,0x3805E0,
       0x1B8AEF,0x6EF61,0x392F4E,0x1B1846,0x1B8D97,0x18FC07,0x381013]
       i = 0
