...
def randomize_keys(char_locs,outfile,locked_chars):
    ...
    if iterations == 3600:
       ...
       "melchior" ,"claw" ,"desert" ,"arris" ,"geno" ,"sun" ,"reptite" ,"woe"]
       pointer1 = [0x393C82,0x35F888,0x37742F,0x380C42,0x3891DE,0x3966B,0x38045D,0x3805DE,0x1B8AEC,
       0x6EF5E,0x392F4C,0x1B1844,0x1B8D95,0x18FC2C,0x381010]
       pointer2 = [0x393C84,0x35F88A,0x377432,0x380C5B,0x3891E0,0x3966D,0x38045F,0x3805E0,
